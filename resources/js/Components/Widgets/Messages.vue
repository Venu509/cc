    ...
    <div class="divide-y divide-gray-100 dark:divide-gray-700">
      <a href="#" class="flex px-4 py-3 hover:bg-gray-100 dark:hover:bg-gray-700">
        <div class="flex-shrink-0">
          ...
          <div class="absolute flex items-center justify-center w-5 h-5 ms-6 -mt-5 bg-secondary-600 border border-white rounded-full dark:border-gray-800">
        ...
        <div class="w-full ps-3">
          ...
          <div class="text-xs text-secondary-600 dark:text-secondary-500">a few moments ago</div>
        </div>
      </a>
      <a href="#" class="flex px-4 py-3 hover:bg-gray-100 dark:hover:bg-gray-700">
        <div class="flex-shrink-0">
        ...
        <div class="w-full ps-3">
          ...
          <div class="text-xs text-secondary-600 dark:text-secondary-500">10 minutes ago</div>
        </div>
      </a>
      <a href="#" class="flex px-4 py-3 hover:bg-gray-100 dark:hover:bg-gray-700">
        <div class="flex-shrink-0">
        ...
        <div class="w-full ps-3">
          ...
          <div class="text-xs text-secondary-600 dark:text-secondary-500">44 minutes ago</div>
        </div>
      </a>
      <a href="#" class="flex px-4 py-3 hover:bg-gray-100 dark:hover:bg-gray-700">
        <div class="flex-shrink-0">
        ...
        <div class="w-full ps-3">
          <div class="text-gray-500 text-sm mb-1.5 dark:text-gray-400"><span class="font-semibold text-gray-900 dark:text-white">Leslie Livingston</span> mentioned you in a comment: <span class="font-medium text-secondary-500" href="#">@bonnie.green</span> what do you say?</div>
          <div class="text-xs text-secondary-600 dark:text-secondary-500">1 hour ago</div>
        </div>
      </a>
      <a href="#" class="flex px-4 py-3 hover:bg-gray-100 dark:hover:bg-gray-700">
        <div class="flex-shrink-0">
        ...
        <div class="w-full ps-3">
          ...
          <div class="text-xs text-secondary-600 dark:text-secondary-500">3 hours ago</div>
        </div>
      </a>
    </div>
